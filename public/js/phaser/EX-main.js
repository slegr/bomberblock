...
var init = function () {
	...
	BasicGame.Boot.prototype =
	{
	    preload: function () {
            ...
            //spritesheet of the ghost with all the angle, and the size of 1 sprite
	    ...
	    create: function () {
	        ...
	        var cactus1;
	        for (var xt = 2048; xt > 0; xt -= 400) {
	            for (var yt = 2048; yt > 0; yt -= 400) {
	        ...
	        // Creste the player
	        player = game.add.isoSprite(350, 280, 900, 'characterAnim', 0, obstacleGroup);
